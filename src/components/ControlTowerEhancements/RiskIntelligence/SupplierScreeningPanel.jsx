        ...
        {results && !loading && (
          <>
            <div style={{ display: "flex", gap: 10, marginBottom: 16, flexWrap: "wrap" }}>
              <div style={{ fontSize: 12, padding: "6px 12px", borderRadius: 20, background: "rgba(148,163,184,0.1)", color: "#94A3B8", fontWeight: 500 }}>
                {summary.total_screened} screened
              </div>
              {summary.uflpa_flagged > 0 && (
                <div style={{ fontSize: 12, padding: "6px 12px", borderRadius: 20, background: "rgba(239,68,68,0.15)", color: "#f87171", fontWeight: 600 }}>
                  🚫 {summary.uflpa_flagged} UFLPA flagged
                </div>
              )}
              {summary.high_or_critical_risk > 0 && (
                <div style={{ fontSize: 12, padding: "6px 12px", borderRadius: 20, background: "rgba(249,115,22,0.12)", color: "#fb923c", fontWeight: 600 }}>
                  ...
                  >
                    ...
                    {isExpanded && (
                      <div style={{ padding: "0 16px 16px 16px", borderTop: "0.5px solid rgba(148,163,184,0.12)" }}>
                        {r.error && (
                          <div style={{ fontSize: 11, color: "#f87171", padding: "10px 0 4px" }}>
                            ⚠ {r.error}
                          </div>
                        )}
                        {r.executive_summary && (
                          <div style={{ fontSize: 11.5, color: "#CBD5E1", lineHeight: 1.7, padding: "12px 0 4px" }}>
                            {r.executive_summary}
                          </div>
                        )}
                        {r.state_dept_advisory?.summary && (
                          <div style={{ fontSize: 10.5, color: "#94A3B8", lineHeight: 1.6, padding: "8px 0 4px" }}>
